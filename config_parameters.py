...
class Parameters:
    ...
    #
    kKdtNmsRadius = (
        3  # pixels  #3            # radius for kd-tree based Non-Maxima Suppression
    )
    #
    ...
    kInitializerNumMinFeatures = 10  # 100 // TODO
    kInitializerNumMinFeaturesStereo = 500
    kInitializerNumMinTriangulatedPoints = 10  # 150 // TODO
    ...
    kUseVolumetricIntegration = (
        False  # To enable/disable volumetric integration (dense mapping)
    )
